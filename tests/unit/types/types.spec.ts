...
interface Dummy {
  ...
  obj2: { name: string; age: number } | undefined
  obj3: { name: string; age: number } | null
  obj4: { name: string; age: number } | undefined | null
  objArr1: { name: string; age: number }[]
  objArr2: { name: string; age: number }[] | undefined
  objArr3: { name: string; age: number }[] | null
  objArr4: { name: string; age: number }[] | undefined | null
  strArr1: string[]
...
describe('DeepPartial', () => {
  ...
  // プリミティブな配列はPartialにならない!
  // このため配列の要素にundefinedの設定はできない
...
describe('DeepReadonly', () => {
  ...
  const dummy: DeepReadonly<Dummy> = {}
